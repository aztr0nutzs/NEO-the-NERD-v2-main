        ...
        {(isDemoMode || routerStatus.readOnlyMode) && (
          <div className="flex items-start gap-2 rounded border border-orange-500/30 bg-orange-500/5 p-3 font-mono text-[10px] text-orange-400">
            ...
            <div>
              {routerStatus.readOnlyMode && (
                <p className="mb-1">
                  READ_ONLY_MODE: Router control actions are disabled until backend is connected.
                </p>
              )}
              {isDemoMode && (
                <p>
                  DEMO_ADAPTER: Toggle actions are simulated. Connect native backend for real router
                  control.
                </p>
              )}
            </div>
