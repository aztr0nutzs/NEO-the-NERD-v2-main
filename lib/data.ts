...
export const GAMES: GameDef[] = [
  ...
  { id: "knxt4", title: "Knxt 4", difficulty: "Hard", estTime: "5 min", behavior: "N.E.O. Connect 4 reactor duel — Classic, Quick, and Timed are playable", multiplayer: "You vs Robot", accent: "cyan", playable: true, statusDetail: "Classic, Quick, and Timed are playable. Ladder, Garage, Training, and Challenge bank are staged.", category: "strategy", skillType: "logic", supportsScore: true, supportsTimer: true, supportsStreakMode: true, recommendedDifficulty: "ADAPTIVE" },
]
